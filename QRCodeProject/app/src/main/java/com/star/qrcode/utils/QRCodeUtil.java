...
/**
 * Created by suxing on 2018/2/27.
 * 二维码工具类
 * 需要 compile 'com.google.zxing:core:3.3.0'
 */
...
public class QRCodeUtil {
    ...
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size) {
        return createQRCodeBitmap(content, size, "UTF-8", "H", "4", Color.BLACK, Color.LTGRAY, null, null, 0F);
    }
